...
**The project home is `E:\Source\cruisn-poc`** — read its
...
`cruisn-poc/gpu/renderer.py` (never hand-edit); build with the command in
cruisn-poc's CLAUDE.md (E:\msys64, OS=Windows_NT exported inside the shell);
after committing here, refresh `cruisn-poc/patch/vunit-poc-patches.patch`
